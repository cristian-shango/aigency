	  	...
	  	<script type="text/javascript">
			$(document).ready(function(){
			    ...
			    $(".add-new").click(function(){
			        ...
			        var row = '<tr>' +
			            '<td><select class="form-control" id="cliente" >'+
							...
							?>
						'</select></td>'+
			            /*'<td><input type="text" class="form-control" name="cliente" id="cliente" placeholder="Cliente"></td>' +*/
			            '<td><input type="text" class="form-control" name="proyecto" id="Proyecto" placeholder="Proyecto"></td>' +
			            '<td><input type="text" class="form-control" name="detalle" id="detalle" placeholder="Detalle"></td>' +
			            '<td><input type="number" class="form-control" name="costo_asignado" id="costo_asignado" placeholder="Costo Asignado"></td>' +
			            '<td><input type="number" class="form-control" name="precio_cliente" id="precio_cliente" placeholder="Precio Cliente"></td>' +
			            '<td><input type="text" class="form-control" name="fecha_cobro" id="fecha_cobro" placeholder="Fecha de Cobro"></td>' +
			            '<td><input type="text" class="form-control" name="forma_cobro" id="forma_cobro" placeholder="Forma de Cobro"></td>' +
			            '<td><input type="number" class="form-control" name="saldo" id="saldo" readonly placeholder="No modificable"></td>' +
						'<td>' + actions + '</td>' +
			        '</tr>';
			    	$("table").append(row);		
				...
				$(document).on("click", ".edit", function(){		
			        $(this).parents("tr").find("td:not(:last-child)").each(function(){
			        	var input_texto = $(this).parents("tr").find('input[type="text"]');
			        	var input_numero = $(this).parents("tr").find('input[type="number"]');
			        	if ($(this).html == input_texto){
							$(this).html('<input type="text" class="form-control" value="' + $(this).text() + '">');
						};
						if ($(this).html == input_numero){
		...
		<div class="container-flex">
			<section id="primero">
				...
				<div class="row">
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><?php echo ($row['forma_cobro']);?></td>
											<td class="valor_saldo_total"><?php echo ($row['saldo']);?></td>
											<td>
												<a class="fas fa-plus add" data-toggle="tooltip" data-id="<?php echo ($row['id']);?>" style="display: none;"></a>
												<a class="fas fa-edit edit" data-toggle="tooltip" data-id="<?php echo ($row['id']);?>"></a>
												<a class="far fa-trash-alt delete" data-toggle="tooltip" data-id="<?php echo ($row['id']);?>" data-nombre="<?php echo ($row['nombre']);?>"></a>
											</td>
										</tr>
								<?php
									        }
					...
					<div class="col-md-1">
				    	<button class="btn btn-block btn-lg btn-success add-new" id="boton_nuevo_proyecto" style="cursor: pointer;"><i class="fas fa-plus"></i></button>
					</div>
					<div class="col-md-1">
				    	<button class="btn btn-block btn-lg btn-danger" id="boton_volver" style="cursor: pointer;"><i class="fas fa-home"></i></button>
					</div>
				</div>
			</section>

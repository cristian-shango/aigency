...
<html class="no-js css-menubar" lang="en">
  ...
  <body class="animsition">
    <a id="apdf" href="cargar_cotizaciones_a_pdf.php?id=<?php echo $_GET['id']; ?>">PASAR A PDF</a>
    <!--[if lt IE 8]>
                ...
                <div class="example-wrap">
                  <div class="example table-responsive">
                    <table class="table table-hover">
                      <tr> <th></th><th></th> <th>Bob</th> <th>Alice</th> </tr> <tr> <th rowspan="2">Favorite</th> <th>Color</th> <td>Blue</td> <td>Purple</td> </tr> <tr> <th>Flavor</th> <td>Banana</td> <td>Chocolate</td> </tr> <tr> <th>Least Favorite</th> <th>Color</th> <td>Yellow</td> <td>Pink</td> </tr> <tr> <th>Flavor</th> <td>Mint</td> <td>Walnut</td> </tr>

Read more: https://html.com/tables/rowspan-colspan/#ixzz5jbH2hPuT
                    </table>
                  </div>
                </div>

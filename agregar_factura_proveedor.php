<?php  
  ...
  if ($check_id_pago == 0){
    if ($archivo_adjunto == "sin_subir"){
      $sql = "INSERT INTO facturas_cotizaciones (id_factura_cotizacion, id_registro_cotizacion, id_proyecto_cotizacion, id_proveedor_cotizacion, id_forma_pago_cotizacion, id_tipo_factura_cotizacion, numero_factura_cotizacion, fecha_factura_cotizacion, tiempo_pago_cotizacion, importe_neto_cotizacion, id_tipo_iva_cotizacion, iva_cotizacion, percepcion_cotizacion, importe_bruto_cotizacion, fecha_pago_cotizacion, observaciones_cotizacion) VALUES ('$id_pago', '$id_registro', '$id_proyecto', '$id_proveedor', '$forma_pago', '$tipo_factura', '$numero_factura', '$fecha_factura', '$tiempo_pago', '$importe_neto', '$tipo_iva', '$iva', '$percepcion', '$importe_bruto', '$fecha_pactada', '$observaciones')";
    } else {
      $sql = "INSERT INTO facturas_cotizaciones (id_factura_cotizacion, id_registro_cotizacion, id_proyecto_cotizacion, id_proveedor_cotizacion, id_forma_pago_cotizacion, id_tipo_factura_cotizacion, numero_factura_cotizacion, fecha_factura_cotizacion, tiempo_pago_cotizacion, importe_neto_cotizacion, id_tipo_iva_cotizacion, iva_cotizacion, percepcion_cotizacion, importe_bruto_cotizacion, factura_adjunta_cotizacion, fecha_pago_cotizacion, situacion_cotizacion, observaciones_cotizacion) VALUES ('$id_pago', '$id_registro', '$id_proyecto', '$id_proveedor', '$forma_pago', '$tipo_factura', '$numero_factura', '$fecha_factura', '$tiempo_pago', '$importe_neto', '$tipo_iva', '$iva', '$percepcion', '$importe_bruto', '$archivo_adjunto', '$fecha_pactada', 1, '$observaciones')";
    }
  } else {
    if ($archivo_adjunto == "sin_subir"){
      $sql = "UPDATE facturas_cotizaciones SET id_factura_cotizacion = '$id_pago' ,id_registro_cotizacion = '$id_registro' ,id_proyecto_cotizacion = '$id_proyecto' ,id_proveedor_cotizacion = '$id_proveedor' ,id_forma_pago_cotizacion = '$forma_pago' ,id_tipo_factura_cotizacion = '$tipo_factura' ,numero_factura_cotizacion = '$numero_factura' ,fecha_factura_cotizacion = '$fecha_factura' ,tiempo_pago_cotizacion = '$tiempo_pago' ,importe_neto_cotizacion = '$importe_neto' ,id_tipo_iva_cotizacion = '$tipo_iva' ,iva_cotizacion = '$iva' ,percepcion_cotizacion = '$percepcion' ,importe_bruto_cotizacion = '$importe_bruto' ,fecha_pago_cotizacion = '$fecha_pactada' ,observaciones_cotizacion = '$observaciones' WHERE id_factura_cotizacion = '$id_pago'";
    } else {
      $sql = "UPDATE facturas_cotizaciones SET id_factura_cotizacion = '$id_pago' ,id_registro_cotizacion = '$id_registro' ,id_proyecto_cotizacion = '$id_proyecto' ,id_proveedor_cotizacion = '$id_proveedor' ,id_forma_pago_cotizacion = '$forma_pago' ,id_tipo_factura_cotizacion = '$tipo_factura' ,numero_factura_cotizacion = '$numero_factura' ,fecha_factura_cotizacion = '$fecha_factura' ,tiempo_pago_cotizacion = '$tiempo_pago' ,importe_neto_cotizacion = '$importe_neto' ,id_tipo_iva_cotizacion = '$tipo_iva' ,iva_cotizacion = '$iva' ,percepcion_cotizacion = '$percepcion' ,importe_bruto_cotizacion = '$importe_bruto' ,factura_adjunta_cotizacion = '$archivo_adjunto', fecha_pago_cotizacion = '$fecha_pactada', situacion_cotizacion = 1 ,observaciones_cotizacion = '$observaciones' WHERE id_factura_cotizacion = '$id_pago'";
    }
  }

			...
			<section id="primero">
				<div class="row">
					...
					<div class="col-md-6 text-right">
						<h3 style="font-size: 3em;">Facturar Proyecto</h3>
					</div>
				</div>
					...
					if($result = mysqli_query($conexion, $sql)){
					    if(mysqli_num_rows($result) > 0){
							...
							<div class="col-md-4">
								<div class="form-group">
								    <h4>OT</h4>
								    <input type="text" class="form-control form-control" id="id_proyecto" readonly value="<?php echo ($row['id']);?>">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
								    ...
								    <select class="form-control" id="tipo_factura">
										...
										?>
										<option value="<?php echo ($row2['tipo_factura']);?>"><?php echo ($row2['tipo_factura']);?></option>
										<?php
											        }
											        // Free result set

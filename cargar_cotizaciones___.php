...
<<<<<<< HEAD
                <div class="cotizacion_pagos_totales">
                  ...
                  <div id="mostrar_costo_presupuestado" class="cotizacion_pagos_totales_plazo col-md-12">
                    <div class="form-group">
                        <h5 class="cotizacion_pagos_totales_label">Pago a 30 días</h5>
                        <div class="input-group">
                        <div class="input-group-prepend">
                          <div class="input-group-text">$</div>
                        </div>
                        <input type="text" class="form-control numerable cotizacion_pagos_totales_monto" id="pago30" readonly value="<?php echo ($valor30dias);?>">
                      </div>
                    </div>
                  </div>

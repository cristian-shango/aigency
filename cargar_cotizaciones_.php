    ...
    <div class="page">
      ...
      <div class="page-main">
        <div class="page-header">
          <h1 class="page-title">Carga de Cotizaciones</h1>
                    ...
                    <div class="example table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr class="mostrar_registro" data-id="<?php echo ($row['id_catcot']);?>" style="background-color: #cccccc;">
                                <td scope="row" style="text-align: center; width: 10%;"><strong><?php echo ($row['nombre_catcot']);?></strong></td>

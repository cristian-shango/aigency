...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="design/global/vendor/flag-icon-css/flag-icon.css">
        <link rel="stylesheet" href="design/assets/examples/css/pages/login-v3.css">
  ...
  <body class="animsition page-login-v3 layout-full">
      ...
      <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        <div class="panel">
          <div class="panel-body">
            <div class="brand">
              <img class="brand-img" src="design/assets//images/logo-colored.png" alt="...">
              <h2 class="brand-text font-size-18">AiGency</h2>
            </div>
            ...
            <!-- <p>Si no tenés cuenta, ingresá <a href="register-v3.html">aquí</a></p> -->
          </div>
        </div>

        <footer class="page-copyright page-copyright-inverse">
          <p>Desarrollado por Viva Shango</p>
    ...
    <script src="design/global/vendor/slidepanel/jquery-slidePanel.js"></script>
        <script src="design/global/vendor/jquery-placeholder/jquery.placeholder.js"></script>
    ...
    <script src="design/global/js/Plugin/switchery.js"></script>
        <script src="design/global/js/Plugin/jquery-placeholder.js"></script>

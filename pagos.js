...
var cotizacion_pagos = (function(){
  ...
  const pagoVacio = { plazo:'', porcentaje:100, forma:'', fecha1:'', fecha2:'', fecha3:'' };
  const pagoDefault = { plazo: '90', porcentaje: 100, forma:'', fecha1:'', fecha2:'', fecha3:'' };
  ...
  function bind_eventos(html=document){
    ...
    $(html).find(".cotizacion_pagos_forma, .cotizacion_pagos_porcentaje, .cotizacion_pagos_plazo, .cotizacion_pagos_fecha1, .cotizacion_pagos_fecha2, .cotizacion_pagos_fecha3").on({
      change: function(){
  ...
  function leer_datos(html){
    ...
    pago_datos.fecha3 = leer_tag($(html).find(".cotizacion_pagos_fecha3")[0]);
  ...
  function cargar_pago_registro(registro) {
    ...
    Object.keys(pagos[registro]).forEach(function(pago){
      ...
      $data = $data_modelo.clone().attr("data-id_pago", pago).appendTo($lista).each(function(ix, data){
          ...
          escribir_tag($(data).find(".cotizacion_pagos_fecha3")[0], pagos[registro][pago].fecha3);
      });

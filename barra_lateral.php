            ...
            <ul class="site-menu" data-plugin="menu">
                ...
                <a href="javascript:void(0)">
                    ...
                    <ul class="site-menu-sub">
                      <li class="site-menu-item">
                        <a class="animsition-link" href="pedido_cotizacion.php">
                          <span class="site-menu-title">Pedido de Cotización</span>
                        </a>
                      </li>
                      <li class="site-menu-item">
                        <a class="animsition-link" href="cotizaciones.php">
                          <span class="site-menu-title">Carga de Cotización</span>
                        </a>
                      </li>
                    </ul>
              </li>
              <li class="site-menu-item has-sub">
                <a href="javascript:void(0)">
                    ...
                    <ul class="site-menu-sub">
                      <li class="site-menu-item">
                        <a class="animsition-link" href="cobros.php">
                          <span class="site-menu-title">Cobros</span>
                        </a>
                      </li>
                      <li class="site-menu-item">
                        <a class="animsition-link" href="pagos.php">
                          <span class="site-menu-title">Pagos</span>
                        </a>
                      </li>
                      <li class="site-menu-item">
                        <a class="animsition-link" href="facturacion.php">
                      ...
                      <li class="site-menu-item">
                        <a class="animsition-link" href="gastos.php">
                          <span class="site-menu-title">Gastos</span>
                        </a>
                      </li>
                      <li class="site-menu-item">
                        <a class="animsition-link" href="sueldos.php">
                          <span class="site-menu-title">Sueldos</span>
                        </a>
                      </li>
                      <li class="site-menu-item">
                        <a class="animsition-link" href="empleados.php">

...
<html class="no-js css-menubar" lang="en">
  ...
  <body class="animsition page-aside-static page-aside-right">
      <script>
          (function() {
            var cx = '011765167890245160051:wclszkxtkuk';
...
<gcse:search></gcse:search>
                ...
                <div class="cotizacion_pagos_totales">
                  ...
                  <div id="mostrar_costo_presupuestado" class="cotizacion_pagos_totales_plazo col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control numerable cotizacion_pagos_totales_monto">
                      </div>
                    </div>
                  </div>
    ...
    <script type="text/javascript">
      ...
      function agregarSubtotales(table) {
          ...
          table.find(".primerRubro").parents('.cotizacion_pagos_group + tr').before($('<tr><td/><td>Subtotales</td><td colspan="7"/><td/></tr>').addClass('subtotales'));
          table.find(".primerRubro").each(function(ix, rubro){
              ...
              while ($tr.length && !$tr.hasClass("subtotales")) {
              ...
              $total = $('<span></span>')
                            ...
                            .addClass('subtotalRubro numerable')
                            .before($('<span>$</span>'))
                            .text(total);

<?php
  ...
  mysql_set_charset('utf8');
      echo "<table class='table border-tabla' id='tabla_reporte_todos'><tbody><tr><th>OP</th><th>STATUS</th><th>CLIENTE</th><th>PRODUCTO</th><th>ITEM</th><th>PROVEEDOR</th><th>RAZON SOCIAL</th><th>IMPORTE NETO</th><th>IVA</th><th>PERCEPCION</th><th>IMPORTE BRUTO</th><th>FORMA DE PAGO</th><th>TIPO FACTURA</th><th>NUMERO FACTURA</th><th>FECHA FACTURA</th><th>TIEMPO DE PAGO</th><th>FECHA DE PAGO</th><th>SITUACION</th></tr>";
